...
autocmd FileType c       nnoremap <buffer> <F5> :!gcc -std=gnu23   -w % -o /tmp/test && /tmp/test<CR>
autocmd FileType cpp     nnoremap <buffer> <F5> :!g++ -std=gnu++23 -w % -o /tmp/test && /tmp/test<CR>
...
autocmd FileType rust    nnoremap <buffer> <F5> :!cargo run \|\| rust-script %<CR>
